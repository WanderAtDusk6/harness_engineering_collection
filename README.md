...
| Spec | 上游 | 性质 | 示例 |
| --- | --- | --- | --- |
| **AGENTS.md** ([source](https://github.com/agentsmd/agents.md) · [demo](specs/agents.md/demo/)) | https://agents.md/ | 跨厂商开放约定 | 项目根 `AGENTS.md`,告诉 agent 怎么 build/test/跑 |
| **SKILL.md** ([source](https://github.com/agentskills/agentskills) · [demo](specs/skill.md/demo/)) | [agentskills.io](https://agentskills.io) · [Anthropic 原文](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) · [博客](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills) | 开放规范(源自 Anthropic,现由独立组织维护) | skill 目录根 `SKILL.md`,带 YAML frontmatter |
